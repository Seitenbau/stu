...
{
  /**
   * @return a truncate Operation used to truncate all Tables
   *         E.g. : {@link DatabaseOperation#TRUNCATE_TABLE}
   */
  DatabaseOperation truncateOperation();

  /**
   * @return the delete Operation used to delete Tables contents
   *         E.g. : {@link DatabaseOperation#DELETE_ALL}
   */
  ...
  /**
   * @return a delete all and truncate/delete Operation used for cleanInsert
   *         E.g. : {@link DatabaseOperation#CLEAN_INSERT}
   */
