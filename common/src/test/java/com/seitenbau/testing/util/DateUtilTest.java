...
public class DateUtilTest
{
  ...
  public void testAsDateFormantsWithMS()
  {
    ...
    assertThat(format1.getYear() + 1900).isEqualTo(2010);
    assertThat(format1.getMonth() + 1).isEqualTo(2);
    assertThat(format1.getDate()).isEqualTo(23);
    assertThat(format1.getHours()).isEqualTo(10);
    assertThat(format1.getMinutes()).isEqualTo(4);
    assertThat(format1.getSeconds()).isEqualTo(12);
  ...
  public void testAsDateWithNoDate()
  {
    ...
    assertThat(format1.getYear() + 1900).isEqualTo(1970);
    assertThat(format1.getMonth() + 1).isEqualTo(1);
    assertThat(format1.getDate()).isEqualTo(1);
    assertThat(format1.getHours()).isEqualTo(10);
    assertThat(format1.getMinutes()).isEqualTo(4);
    assertThat(format1.getSeconds()).isEqualTo(12);
  ...
  public void testAsDateWithNoTime()
  {
    ...
    assertThat(format1.getMonth() + 1).isEqualTo(2);
    assertThat(format1.getDate()).isEqualTo(23);
    assertThat(format1.getHours()).isEqualTo(0);
    assertThat(format1.getMinutes()).isEqualTo(0);
    assertThat(format1.getSeconds()).isEqualTo(0);
  ...
  {
    Date datum = DateUtil.asDate("2010-02-23 10:04:12.894");
    DateBuilder builder = DateUtil.datum(datum)
        .set(15).second()
        .set(14).minute()
        .set(13).hour()
        .set(12).day()
