...
import com.seitenbau.stu.database.extend.impl.MySQLDisableAllConstraints;
...
public class MySQLDisableAllConstraintsTest
{
  ...
  {
    protected java.sql.Connection getConnection(com.seitenbau.stu.database.tester.DatabaseTesterBase<?> tester)
