 ...
 * <code>
 * <pre>
 * AddConstraint addConstraint = new AddConstraint("calculation.a", "calculation.b", "calculation.c"); 
 * AddConstraint addConstraint = new AddConstraint("calculation.a", "calculation.b", new IntValue(10)); 
 * AddConstraint addConstraint = new AddConstraint("calculation.a", new IntValue(5), "calculation.c"); 
 * AddConstraint addConstraint = new AddConstraint(new DoubleValue(4.5), "calculation.b", "calculation.c"); 
 * AddConstraint addConstraint = new AddConstraint("calculation.a", new IntValue(5), new DoubleValue(4.5)); 
 * AddConstraint addConstraint = new AddConstraint(new IntValue(2), "calculation.b", new IntValue(10)); 
 * AddConstraint addConstraint = new AddConstraint(new IntValue(5), new IntValue(5), "calculation.c"); 
 * </pre>
 * </code>
 */
public class AddConstraint extends FunctionConstraint {

	/**
	 * <p>
	 * {@code public AddConstraint(String sourceName1, String sourceName2,
			String resultSource)}
	 * </p>
	 * 
	 * <p>
	 * Creates an AddConstraint instance, which specifies that the sum of the
	 ...
	 *            {@code table.column}.
	 */
	public AddConstraint(String sourceName1, String sourceName2,
			String resultSource) {
	...
	/**
	 * <p>
	 * {@code public AddConstraint(String sourceName1, Value<?> value), String resultSource)}
	 * </p>
	 * 
	 * <p>
	 * Creates an AddConstraint instance, which specifies that the sum of the
	...
	/**
	 * <p>
	 * {@code public AddConstraint(Value<?> value), String sourceName1, String resultSource)}
	 * </p>
	 * 
	 * <p>
	 * Creates an AddConstraint instance, which specifies that the sum of the
	...
	/**
	 * <p>
	 * {@code public AddConstraint(String sourceName1, Value<?> value1, Value<?> value2)}
	 * </p>
	 * 
	 * <p>
	 * Creates an AddConstraint instance, which specifies that the sum of the
	...
	/**
	 * <p>
	 * {@code public AddConstraint(Value<?> value1, String sourceName1, Value<?> value2)}
	 * </p>
	 * 
	 * <p>
	 * Creates an AddConstraint instance, which specifies that the sum of the
	...
	/**
	 * <p>
	 * {@code public AddConstraint(Value<?> value1, Value<?> value2, String resultSource)}
	 * </p>
	 * 
	 * <p>
	 * Creates an AddConstraint instance, which specifies that the sum of the
