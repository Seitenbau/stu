 ...
 * <code>
 * <pre>
 * DivConstraint divConstraint = new DivConstraint("calculation.a", "calculation.b", "calculation.c"); 
 * DivConstraint divConstraint = new DivConstraint("calculation.a", "calculation.b", new IntValue(10)); 
 * DivConstraint divConstraint = new DivConstraint("calculation.a", new IntValue(5), "calculation.c"); 
 * DivConstraint divConstraint = new DivConstraint(new DoubleValue(4.5), "calculation.b", "calculation.c"); 
 * DivConstraint divConstraint = new DivConstraint("calculation.a", new IntValue(5), new DoubleValue(4.5)); 
 * DivConstraint divConstraint = new DivConstraint(new IntValue(2), "calculation.b", new IntValue(10)); 
 * DivConstraint divConstraint = new DivConstraint(new IntValue(5), new IntValue(5), "calculation.c"); 
 * </pre> </code>
 */
public class DivConstraint extends FunctionConstraint {

	/**
	 * <p>
	 * {@code public DivConstraint(String sourceName1, String sourceName2,
			String resultSource)}
	 * </p>
	 * 
	 * <p>
	 * Creates an DivConstraint instance, which specifies that the quotient of the
	 ...
	 *            {@code table.column}.
	 */
	public DivConstraint(String sourceName1, String sourceName2,
			String resultSource) {
	...
	/**
	 * <p>
	 * {@code public DivConstraint(String sourceName1, Value<?> value), String resultSource)}
	 * </p>
	 * 
	 * <p>
	 * Creates an DivConstraint instance, which specifies that the quotient of the
	...
	/**
	 * <p>
	 * {@code public DivConstraint(Value<?> value), String sourceName1, String resultSource)}
	 * </p>
	 * 
	 * <p>
	 * Creates an DivConstraint instance, which specifies that the quotient of the
	...
	/**
	 * <p>
	 * {@code public DivConstraint(String sourceName1, Value<?> value1, Value<?> value2)}
	 * </p>
	 * 
	 * <p>
	 * Creates an DivConstraint instance, which specifies that the quotient of the
	...
	/**
	 * <p>
	 * {@code public DivConstraint(Value<?> value1, String sourceName1, Value<?> value2)}
	 * </p>
	 * 
	 * <p>
	 * Creates an DivConstraint instance, which specifies that the quotient of the
	...
	/**
	 * <p>
	 * {@code public DivConstraint(Value<?> value1, Value<?> value2, String resultSource)}
	 * </p>
	 * 
	 * <p>
	 * Creates an DivConstraint instance, which specifies that the quotient of the
