...
**********************************************************/
public abstract class PersonDatabaseDataSet
             implements com.seitenbau.testing.dbunit.extend.DbUnitDatasetFactory
{
  ...
  public PersonDatabaseDataSet modify(PersonDatabaseDataSetModifier...modifiers) 
  {
    if(modifiers==null) { return this; }
    for(PersonDatabaseDataSetModifier modifier : modifiers) 
    {
   ...
   */ 
  public interface PersonDatabaseDataSetModifier
  {
    void modify(PersonDatabaseDataSet dataset);
  }
