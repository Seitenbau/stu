...
public class TeamsTable {
  ...
  private final ITableAdapter<RowBuilder_Teams, TeamsWhere> _adapter = new ITableAdapter<RowBuilder_Teams, TeamsWhere>()
  {
  ...
  public void rows(Closure<?> rows) {
    GeneralTableRowCallback<RowBuilder_Teams, TeamsWhere, TeamsRef> callback = 
        new GeneralTableRowCallback<RowBuilder_Teams, TeamsWhere, TeamsRef>(_adapter, _usedRefs);
