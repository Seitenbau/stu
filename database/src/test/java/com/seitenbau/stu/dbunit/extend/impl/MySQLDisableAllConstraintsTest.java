...
import com.seitenbau.stu.dbunit.extend.impl.MySQLDisableAllConstraints;
...
public class MySQLDisableAllConstraintsTest
{
  ...
  {
    protected java.sql.Connection getConnection(com.seitenbau.stu.dbunit.tester.DatabaseTesterBase<?> tester)
