...
public class DomainSpecificDataBuilder {
	...
	public DomainSpecificDataBuilder() {
		...
		DomainSpecificDataHint juergen = addData("firstname", "Jürgen");
		
		DomainSpecificDataHint deutschland = addData("country", "Deutschland");
		DomainSpecificDataHint oesterreich = addData("country", "Österreich");
		...
		DomainSpecificDataHint parkstrasse = addData("steet", "Parkstraße");
