...
**********************************************************/
public class IsTutorTable implements ITable
{
  public final static String NAME = "IS_TUTOR";
  ...
  Iterator<RowBuilder_IsTutor> _iterator;
  ...
  public List<RowBuilder_IsTutor> rows = new ArrayList<RowBuilder_IsTutor>();
  
  public interface RowSetters_IsTutor<T extends RowSetters_IsTutor>
  {
  ...
  public interface RowGetters_IsTutor<T extends RowGetters_IsTutor>
  {
  ...
  public static class RowBuilder_IsTutor implements RowSetters_IsTutor<RowBuilder_IsTutor>, RowGetters_IsTutor<RowBuilder_IsTutor>
  {
    ...
    RowBuilder_IsTutor(IsTutorTable tableDelegate) {
      data=new Object[COLUMNS.length];
      table = tableDelegate;
    }
    

    public RowBuilder_IsTutor setStudentId(Integer intValue)
    {
      data[ 0 ] = (intValue==null?null:Long.valueOf(intValue));
      return this;
    }
    public RowBuilder_IsTutor setStudentId(java.lang.Long value)
    {
      data[ 0 ] = value;
      return this;
    }
    public RowBuilder_IsTutor setStudentIdRaw(Object value)
    {
      data[ 0 ] = value;
      return this;
    }
    ...
    public RowBuilder_IsTutor setLectureId(Integer intValue)
    {
      data[ 1 ] = (intValue==null?null:Long.valueOf(intValue));
      return this;
    }
    public RowBuilder_IsTutor setLectureId(java.lang.Long value)
    {
      data[ 1 ] = value;
      return this;
    }
    public RowBuilder_IsTutor setLectureIdRaw(Object value)
    {
      data[ 1 ] = value;
      return this;
    }
    ...
    * <code><pre>
    * ds.table_IsTutor.insertRow()
    *   .setStudentId( null )
    *   .setLectureId( null )
    *   ;
    * </pre></code>
    */
    public RowBuilder_IsTutor insertRow()
    {
    ...
    * </pre></code>
    */
    public RowBuilder_IsTutor insertRow(IsTutorModel row)
    {
    ...
    * <code><pre>
    * ds.table_IsTutor.this.insertRowAt(2)
    *   .setStudentId( null )
    *   .setLectureId( null )
    *   ;
    * </pre></code>
    */
    public RowBuilder_IsTutor insertRowAt(int index)
    {
    ...
    * <code><pre>
    * ds.table_IsTutor.insertRow(baseUser);
    * </pre></code>
    */
    public RowBuilder_IsTutor insertRow(RowBuilder_IsTutor theRow)
    {
    ...
    public RowBuilder_IsTutor refStudentId(RowGetters_Student reference)
    {
      setStudentId(reference.getStudentNumber());
      return this;
    }

    public RowBuilder_IsTutor refLectureId(RowGetters_Lecture reference)
    {
    ...
    @Override
    public RowBuilder_IsTutor clone() {
      RowBuilder_IsTutor clone = new RowBuilder_IsTutor(table);
  ...
  public IsTutorWhere findWhere = new IsTutorWhere(this);

  public static class IsTutorWhere
  {
    public List<RowBuilder_IsTutor> rows;
    IsTutorTable table;
    
    public IsTutorWhere(IsTutorTable theTable) {
       rows = theTable.rows;
       table = theTable;
    }
    
    public RowCollection_IsTutor rowComparesTo(Comparable<RowBuilder_IsTutor> toSearch) {
      RowCollection_IsTutor modifiers = new RowCollection_IsTutor(table);
      for (RowBuilder_IsTutor row : rows) 
      {
    ...
    public RowCollection_IsTutor studentId(java.lang.Long toSearch) {
      RowCollection_IsTutor modifiers = new RowCollection_IsTutor(table);
      for (RowBuilder_IsTutor row : rows) 
      {
    ...
    public RowCollection_IsTutor studentId(Integer toSearch) 
    {
      return studentId( Long.valueOf(toSearch) );
    }
    public RowCollection_IsTutor lectureId(java.lang.Long toSearch) {
      RowCollection_IsTutor modifiers = new RowCollection_IsTutor(table);
      for (RowBuilder_IsTutor row : rows) 
      {
    ...
    public RowCollection_IsTutor lectureId(Integer toSearch) 
    {
      return lectureId( Long.valueOf(toSearch) );
    }
  }
  
  /** Inner class! Use RowCollection_IsTutor in your code ! */
  public static class RowModify_IsTutor extends RowBuilder_IsTutor 
  {
      List<RowBuilder_IsTutor> _rows;

      public RowModify_IsTutor(IsTutorTable theTable) {
        super(theTable);
        _rows = new ArrayList<RowBuilder_IsTutor>();
      }
      
      public void add(RowBuilder_IsTutor row) {
          _rows.add(row);
      }
      ...
      public RowModify_IsTutor delete() {
          for(RowBuilder_IsTutor row : _rows) {
      ...
      public RowModify_IsTutor setStudentId(Integer intValue)
      {
        for(RowBuilder_IsTutor row : _rows) {
      ...
      public RowModify_IsTutor setStudentId(java.lang.Long value)
      {
        for(RowBuilder_IsTutor row : _rows) {
      ...
      public RowModify_IsTutor setStudentIdRaw(Object value)
      {
        for(RowBuilder_IsTutor row : _rows) {
      ...
      public RowModify_IsTutor setLectureId(Integer intValue)
      {
        for(RowBuilder_IsTutor row : _rows) {
      ...
      public RowModify_IsTutor setLectureId(java.lang.Long value)
      {
        for(RowBuilder_IsTutor row : _rows) {
      ...
      public RowModify_IsTutor setLectureIdRaw(Object value)
      {
        for(RowBuilder_IsTutor row : _rows) {
      ...
      @Override
      public RowModify_IsTutor clone() {
        RowModify_IsTutor clone = new RowModify_IsTutor(table);
        for(RowBuilder_IsTutor row:_rows) {
  ...
  public static class RowCollection_IsTutor extends RowModify_IsTutor {
    public IsTutorWhere where = new IsTutorWhere(table);
    
    public RowCollection_IsTutor(IsTutorTable theTable)
    {
      super(theTable);
    }
  ...
  */
  public RowBuilder_IsTutor insertRow()
  {
    RowBuilder_IsTutor row = new RowBuilder_IsTutor(this);
    rows.add(row);
    return row;
  }
  ...
  * </pre></code>
  */
  public RowBuilder_IsTutor insertRow(IsTutorModel rowToAdd)
  {
    RowBuilder_IsTutor row = new RowBuilder_IsTutor(this);
  ...
  /**
  * <code><pre>
  * ds.table_IsTutor.insertRow(data);
  * </pre></code>
  */
  public RowBuilder_IsTutor insertRow(RowBuilder_IsTutor theRow)
  {
  ...
  /**
  * <code><pre>
  * ds.table_IsTutor.insertRows(data);
  * </pre></code>
  */
  public void insertRows(RowBuilder_IsTutor...theRows)
  {
  ...
  * <code><pre>
  * ds.table_IsTutor.insertRowAt(3)
  *   ;
  * </pre></code>
  */
  public RowBuilder_IsTutor insertRowAt(int index)
  ...
  * </pre></code>
  */
  public RowBuilder_IsTutor insertRowAt(int index,RowBuilder_IsTutor theRow)
  {
   ...
   */ 
  public RowBuilder_IsTutor deleteRow(int index)
  {
    RowBuilder_IsTutor rowBuilder = rows.get(index);
   ...
   */ 
  public RowBuilder_IsTutor deleteRow(RowBuilder_IsTutor rowToDelete)
  {
  ...
  */
  public RowBuilder_IsTutor newRow()
  {
    RowBuilder_IsTutor row = new RowBuilder_IsTutor(this);
    return row;
  }
  ...
  * the first call.
  */
  public RowBuilder_IsTutor next()
  {
    if(_iterator == null) {
